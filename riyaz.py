...
bot = telebot.TeleBot('7720816477:AAFSzU7pIRfH_rX1TD7dzqv3raEtzFtVYC0')
...
def create_random_key(length=10):
    ...
    custom_key = f"MUSTAFA-VIP-{random_key.upper()}"
    return custom_key
...
def start_command(message):
    ...
    bot.reply_to(message, "WELCOMETOVIP DDOS!", reply_markup=markup)
